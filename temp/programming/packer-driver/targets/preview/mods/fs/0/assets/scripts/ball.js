    ...
    execute: function () {
      ...
      _export("Ball", Ball = (_dec = ccclass('Ball'), _dec2 = property(SpriteFrame), _dec(_class = (_class2 = (_temp = /*#__PURE__*/function (_Component) {
        ...
        function Ball() {
          ...
          _initializerDefineProperty(_assertThisInitialized(_this), "destroyed", _descriptor, _assertThisInitialized(_this));
        ...
        return Ball;
      }(Component), _temp), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "destroyed", [_dec2], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
